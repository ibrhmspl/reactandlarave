...
Route::get('sub_category', [\App\Http\Controllers\SubCategoriesController::class, 'index']);
Route::post('sub_category', [\App\Http\Controllers\SubCategoriesController::class, 'store']);
Route::put('sub_category/{id}', [\App\Http\Controllers\SubCategoriesController::class, 'update']);
Route::delete('sub_category/{id}', [\App\Http\Controllers\SubCategoriesController::class, 'destroy']);
